            ...
            <div className="w-full grid md:grid-cols-12 gap-12 items-center relative z-10">
                ...
                >
                    {isCinephile ? (
                        ...
                        <h1 className="text-7xl md:text-9xl font-serif tracking-tight text-elegant-dark mb-4 leading-tight">
                            <motion.span 
                    ...
                    <div className={`text-xl md:text-2xl mb-10 max-w-xl leading-relaxed mt-8 space-y-4 font-medium uppercase tracking-wide ${isCinephile ? 'text-slate-300' : 'text-slate-600'}`}>
                ...
                >
                    ...
                    <motion.div 
                        ...
                        className={`transition-all duration-500 p-4 pb-12 z-20 w-80 relative group ${isCinephile 
                    ...
                    >
                        ...
                        <div className={`absolute bottom-3 left-0 right-0 text-center tracking-[0.4em] uppercase ${isCinephile ? 'font-comic text-2xl text-ink' : 'font-sans text-[9px] font-black text-elegant-gold/80'}`}>
                    ...
                    {!isCinephile && (
                        <>
                            <motion.div 
                                ...
                                className="absolute -top-10 -right-10 w-24 h-24 glass-elegant rounded-full shimmer-gold hidden md:block"
                            />
                            <motion.div 
                                animate={{ y: [0, 20, 0], rotate: [0, -10, 0] }}
                                transition={{ duration: 7, repeat: Infinity, ease: "easeInOut", delay: 1 }}
                                className="absolute -bottom-10 -left-10 w-32 h-32 glass-elegant rounded-full flex items-center justify-center hidden md:block"
                            >
